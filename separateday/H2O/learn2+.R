...
dlmodel1 = h2o.deeplearning(data=train_train, validation=train_valid, x=names, y='click',
                            ...
                            balance_classes=TRUE, epochs = 0.1, seed=myseed)
...
save(dllogloss,file=paste0("dllogloss_",randrate,".Rda"))
...
gbmmodel <- h2o.gbm(data=train_train, validation=train_valid, x=names, y='click',
                    n.tree=1, interaction.depth=10, n.minobsinnode = 40, 
...
save(gbmlogloss,file=paste0("gbmlogloss_",randrate,".Rda"))
...
#                     iter.max = 500)
h2o.rm(localH2O, grep(pattern = "train_", x = h2o.ls(localH2O)$Key, value = TRUE))
