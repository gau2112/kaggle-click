...
beta = 9.   # smoothing parameter for adaptive learning rate
L1 = 0.     # L1 regularization, larger value means more regularized
L2 = 25.     # L2 regularization, larger value means more regularized

# C, feature/hash trick
D = 9449236+1             # number of weights to use
...
f = open('./click/indexdicall.pkl', 'rb')
