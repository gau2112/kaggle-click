...
submission = 'logistic3+.csv'  # path of to be outputted submission file

# B, model
alpha = .45  # learning rate
beta = 12.   # smoothing parameter for adaptive learning rate
L1 = 22.     # L1 regularization, larger value means more regularized
L2 = 85.     # L2 regularization, larger value means more regularized

# C, feature/hash trick
D = 566660+1             # number of weights to use
...
f = open('./click/indexdicalltrimed.pkl', 'rb')
